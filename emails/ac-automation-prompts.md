# ActiveCampaign Automation Prompts
# Paste each prompt into the AC AI automation builder one at a time.
# Each prompt creates one complete automation with all emails.
# Replace [TRIAL_LINK] with: https://buy.stripe.com/9B68wP37U6Mf9wzfa45Rm05
# Replace [GUIDE_PDF_LINK] with the actual hosted PDF URL once created.

---

## PROMPT 1: Lead Magnet Nurture

Build me an automation called "Lead Magnet Nurture" with the following setup:

Trigger: When the tag "lead-magnet" is added to a contact.

Goal: If the contact gets the tag "onboarding" added at any point, exit the automation immediately.

The automation sends 4 plain text emails from Dan (info@konteks.co). All emails must be plain text format - no HTML design, no images, no buttons. Just text and links. Keep the formatting exactly as I provide it.

EMAIL 1 - Send immediately after trigger:
Subject line: here's your guide
Body:
Hey %FIRSTNAME%,
...
EMAIL 2:
Subject line: why they say "push it further"
Body:
...
If you want to see inside: https://buy.stripe.com/9B68wP37U6Mf9wzfa45Rm05
...
EMAIL 3:
Subject line: she went from dreading crits to looking forward to them
Body:
...
https://buy.stripe.com/9B68wP37U6Mf9wzfa45Rm05
...
## PROMPT 2: Quiz - The Last-Minuter

Build me an automation called "Quiz - The Last-Minuter" with the following setup:

Trigger: When the tag "quiz-last-minuter" is added to a contact.

Goal: If the contact gets the tag "onboarding" added at any point, exit the automation immediately.

The automation sends 3 plain text emails from Dan (info@konteks.co). All emails must be plain text format - no HTML design, no images, no buttons. Just text and links.

EMAIL 1 - Send immediately after trigger:
Subject line: your result: The Last-Minuter
Body:
Hey %FIRSTNAME%,
...
Want to try it? 7 days free: https://buy.stripe.com/9B68wP37U6Mf9wzfa45Rm05
...
EMAIL 2:
Subject line: why planning ahead still doesn't work
Body:
...
EMAIL 3:
Subject line: try this next deadline week
Body:
...
## PROMPT 3: Quiz - The Concept Struggler

Build me an automation called "Quiz - The Concept Struggler" with the following setup:

Trigger: When the tag "quiz-concept-struggler" is added to a contact.
...
EMAIL 1 - Send immediately after trigger:
Subject line: your result: The Concept Struggler
Body:
Hey %FIRSTNAME%,
...
Try it free for 7 days: https://buy.stripe.com/9B68wP37U6Mf9wzfa45Rm05
...
EMAIL 2:
Subject line: where good concepts actually come from
Body:
...
EMAIL 3:
Subject line: the 3-question concept test
Body:
...
## PROMPT 4: Quiz - The Imposter

Build me an automation called "Quiz - The Imposter" with the following setup:

Trigger: When the tag "quiz-imposter" is added to a contact.
...
EMAIL 1 - Send immediately after trigger:
Subject line: your result: The Imposter
Body:
Hey %FIRSTNAME%,
...
EMAIL 2:
Subject line: your "stupid" ideas are the good ones
Body:
...
EMAIL 3:
Subject line: you're allowed to be confused
Body:
Quick message.
...
## PROMPT 5: Quiz - The High Achiever

Build me an automation called "Quiz - The High Achiever" with the following setup:

Trigger: When the tag "quiz-high-achiever" is added to a contact.
...
EMAIL 1 - Send immediately after trigger:
Subject line: your result: The High Achiever
Body:
Hey %FIRSTNAME%,
...
EMAIL 2:
Subject line: what separates good from best
Body:
...
EMAIL 3:
Subject line: for the students who want to be remembered
Body:
...
## AC TAGS TO CREATE FIRST

Before building any automations, create these tags in ActiveCampaign:
1. lead-magnet
2. quiz-last-minuter
3. quiz-concept-struggler
4. quiz-imposter
5. quiz-high-achiever

## AC CUSTOM FIELD TO CREATE

Create a custom contact field:
- Field label: quiz_result
...
3. Build Automation 1 (Lead Magnet Nurture) using Prompt 1
4. Build Automation 2 (Quiz - Last-Minuter) using Prompt 2
5. Build Automation 3 (Quiz - Concept Struggler) using Prompt 3
6. Build Automation 4 (Quiz - Imposter) using Prompt 4
7. Build Automation 5 (Quiz - High Achiever) using Prompt 5
8. Activate all 5 automations
